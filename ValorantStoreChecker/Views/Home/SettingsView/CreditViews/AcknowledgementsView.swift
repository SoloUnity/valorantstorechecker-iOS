        ...
        Form {
            Section() {
                ...
                Button {
                    ...
                    SettingItemView(itemType: "generic", name: "Lunac", iconBG: .green, iconColour: .white, image: "globe", showChevron: true, toggleBool: $dummy)
                }
            ...
            Section() {
                ...
                Button {
                    ...
                    SettingItemView(itemType: "custom", name: "Julian", iconBG: .cyan, iconColour: .white, image: "github", showChevron: true, toggleBool: $dummy)
                }
